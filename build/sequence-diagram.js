...
function(module, exports, __webpack_require__) {
	...
	*/
    ...
    }).call(exports, __webpack_require__(9)(module), __webpack_require__(8));
}, /* 6 */
/***/
function(module, exports, __webpack_require__) {
    /** js sequence diagrams
    ...
    if ("undefined" != typeof jQuery) {
        var Diagram = __webpack_require__(1);
        !function($) {
...
function(module, exports, __webpack_require__) {
    ...
    var Diagram = __webpack_require__(1), _ = __webpack_require__(3), DIAGRAM_MARGIN = 10, ACTOR_MARGIN = 10, ACTOR_PADDING = 10, SIGNAL_MARGIN = 5, SIGNAL_PADDING = 5, NOTE_MARGIN = 10, NOTE_PADDING = 5, NOTE_OVERLAP = 15, TITLE_MARGIN = 0, TITLE_PADDING = 5, SELF_SIGNAL_WIDTH = 20, PLACEMENT = Diagram.PLACEMENT, LINETYPE = Diagram.LINETYPE, ARROWTYPE = Diagram.ARROWTYPE, LINE = {
        stroke: "#000",
        "stroke-width": 2
    }, RECT = {
        fill: "#fff"
    ...
    Raphael.fn.line = function(x1, y1, x2, y2) {
        return assert(_.every([ x1, x2, y1, y2 ], _.isFinite), "x1,x2,y1,y2 must be numeric"), 
    ...
    Raphael.fn.handRect = function(x, y, w, h) {
        return assert(_.every([ x, y, w, h ], _.isFinite), "x, y, w, h must be numeric"), 
    ...
    _.extend(BaseTheme.prototype, {
        ...
        layout: function() {
            ...
            }.bind(this)), _.each(signals, function(s) {
