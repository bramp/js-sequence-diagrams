...
(function() {
        ...
        var parser = {
            ...
            performAction: function(yytext, yyleng, yylineno, yy, yystate, $$) {
                ...
                switch (yystate) {
                  ...
                  case 17:
                    this.$ = yy.getActor($$[$0].trim().replace(/\\n/gm, "\n"));
                    break;
    ...
    exports.Parser = grammar.Parser, exports.parse = function() {
    ...
    ParseError.prototype = new Error(), Diagram.ParseError = ParseError, grammar.parseError = function(message, hash) {
    ...
    var DIAGRAM_MARGIN = 10, ACTOR_MARGIN = 10, ACTOR_PADDING = 10, SIGNAL_MARGIN = 5, SIGNAL_PADDING = 5, NOTE_MARGIN = 10, NOTE_PADDING = 5, NOTE_OVERLAP = 15, TITLE_MARGIN = 0, TITLE_PADDING = 5, SELF_SIGNAL_WIDTH = 20, PLACEMENT = Diagram.PLACEMENT, LINETYPE = Diagram.LINETYPE, ARROWTYPE = Diagram.ARROWTYPE, LINE = {
        stroke: "#000",
        "stroke-width": 2
    }, RECT = {
        fill: "#fff"
    ...
    _.extend(BaseTheme.prototype, {
        ...
        layout: function() {
            ...
            _.each(actors, function(a) {
                ...
                a.text_bb = bb, a.x = 0, a.y = 0, a.width = bb.width + 2 * (ACTOR_PADDING + ACTOR_MARGIN), 
                a.height = bb.height + 2 * (ACTOR_PADDING + ACTOR_MARGIN), a.distances = [], a.padding_right = 0, 
                ...
                b = Math.max(s.actorA.index, s.actorB.index)); else {
                    ...
                    b = Math.max(s.actor[0].index, s.actor[1].index), extra_width = -(2 * NOTE_PADDING + 2 * NOTE_OVERLAP); else if (s.placement == PLACEMENT.OVER) return a = s.actor.index, 
                    actor_ensure_distance(a - 1, a, s.width / 2), actor_ensure_distance(a, a + 1, s.width / 2), 
                    this._signals_height += s.height, void 0;
                }
            ...
            }, this), diagram.width = Math.max(actors_x, diagram.width), diagram.width += 2 * DIAGRAM_MARGIN, 
